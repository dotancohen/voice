...
def uuid_bytes_to_hex(b: bytes) -> str:
...
def large_db(test_config_dir: Path) -> Generator[Database, None, None]:
    ...
    for branch in range(10):
        ...
        for level in range(10):
            ...
            tag_id_hex = uuid_bytes_to_hex(tag_id)
    ...
    for note_num in range(1, 1001):
        ...
        note_id_hex = uuid_bytes_to_hex(note_id)
        ...
        for i in range(num_tags):
            ...
            assigned_tag_id_hex = uuid_bytes_to_hex(assigned_tag_id)
            try:
