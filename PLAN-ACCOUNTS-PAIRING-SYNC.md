...
8. Stage 8, the wizard, with Stage 14's bucket hardening and Stage 13's
   ...
   **Stage 13's content hash and upload in parts done 2026-09-13** (FILE-18,
   ...
   audio format done 2026-09-13** (FILE-20, FILE-21). **Where each copy of a
   recording is, the account's upload limit, Issues, and tests against a real
   S3 (moto) and a failing network done 2026-09-14** (FILE-14, FILE-22,
   FILE-23, ISSUE-1).
